...
class AnalysisProcessor(processor.ProcessorABC):
    ...
    def process(self, events):
        ...
        j['isGood']  = isTightJet(j.pt, j.eta, j.jetId, j.neHEF, j.neEmEF, j.chHEF, j.chEmEF, j.nConstituents) #j.pt_nom is the skimmed version
        ...
        Lep3 = events['event'][events['nLep'] == 3]
        nLep3 = len(Lep3)
        print('when n = 3, nLep = %i'%(nLep3))
        ...
        Lep4 = events['event'][events['nLep'] >= 4]
        nLep4 = len(Lep4)
        print('when n >= 4, nLep = %i'%(nLep4))
