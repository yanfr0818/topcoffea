...
class AnalysisProcessor(processor.ProcessorABC):
    ...
    def process(self, df):
        ...
        e['isGood'] = isElecMVA(e.pt, e.eta, e.dxy, e.dz, e.miniIso, e.sip3d, e.mvaTTH, e.elecMVA, e.lostHits, e.convVeto, e.tightCharge, e.siesie, e.hoe, e.eInvMinusPInv, minpt=10)
