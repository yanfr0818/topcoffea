...
def Draw(var, categories, label='', dataOnly=False, allprocess=False):
  plt = plotter(path, prDic=processDic, bkgList=bkglist, category=categories, dataOnly=dataOnly, allprocess=allprocess)
  plt.plotData = True
...
Draw(opt.variable, categories, opt.title, dataOnly=True, allprocess=True)
