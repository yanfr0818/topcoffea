...
def isElecMVA(pt, eta, dxy, dz, miniIso, sip3D, mvaTTH, elecMVA, lostHits, convVeto, tightCharge, hoe, eInvMinusPInv,jetDeepB=0, minpt=10):
  ...
  maskSiesie = np.ones_like(pt)#((abs(eta)<1.44)(sieie<0.011))&((abs(eta)>1.44)(sieie<0.030))
