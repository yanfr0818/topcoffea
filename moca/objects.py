...
def isElecMVA(pt, eta, dxy, dz, miniIso, sip3D, mvaTTH, elecMVA, lostHits, convVeto, tightCharge, sieie, hoe, eInvMinusPInv,jetDeepB=0, minpt=10):
  ...
  maskSieie  = ((abs(eta)<1.44)&(sieie<0.011))|((abs(eta)>1.44)&(sieie<0.030))
